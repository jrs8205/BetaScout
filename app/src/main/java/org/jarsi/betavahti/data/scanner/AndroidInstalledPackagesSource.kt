...
/**
 * Ohut adapteri oikean PackageManagerin päälle. Ei logiikkaa —
 * kaikki päättely tehdään DefaultPackageScannerissa (yksikkötestattu).
 * Vaatii QUERY_ALL_PACKAGES-luvan nähdäkseen kaikki paketit.
 */
